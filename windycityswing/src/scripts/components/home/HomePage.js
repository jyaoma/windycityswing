...
class HomePage extends React.Component {
    ...
    renderCalendar () {
        ...
        const firstWeek = <tr key={1} className='event-calendar__week-one'>
            <CalendarDay day={dayOfTheWeekOfTheFirstDayOfTheMonth === 0 ? currentDay++ : undefined}/>
            <CalendarDay day={dayOfTheWeekOfTheFirstDayOfTheMonth <= 1 ? currentDay++ : undefined}/>
            <CalendarDay day={dayOfTheWeekOfTheFirstDayOfTheMonth <= 2 ? currentDay++ : undefined}/>
            <CalendarDay day={dayOfTheWeekOfTheFirstDayOfTheMonth <= 3 ? currentDay++ : undefined}/>
            <CalendarDay day={dayOfTheWeekOfTheFirstDayOfTheMonth <= 4 ? currentDay++ : undefined}/>
            <CalendarDay day={dayOfTheWeekOfTheFirstDayOfTheMonth <= 5 ? currentDay++ : undefined}/>
            <CalendarDay day={dayOfTheWeekOfTheFirstDayOfTheMonth <= 6 ? currentDay++ : undefined}/>
        </tr>;
        ...
        if (maxDaysInCurrentMonth === 28 && dayOfTheWeekOfTheFirstDayOfTheMonth === 0) {
            ...
            fifthWeek = <tr key={5}>
                <CalendarDay day={currentDay <= maxDaysInCurrentMonth ? currentDay++ : undefined}/>
                <CalendarDay day={currentDay <= maxDaysInCurrentMonth ? currentDay++ : undefined}/>
                <CalendarDay day={currentDay <= maxDaysInCurrentMonth ? currentDay++ : undefined}/>
                <CalendarDay day={currentDay <= maxDaysInCurrentMonth ? currentDay++ : undefined}/>
                <CalendarDay day={currentDay <= maxDaysInCurrentMonth ? currentDay++ : undefined}/>
